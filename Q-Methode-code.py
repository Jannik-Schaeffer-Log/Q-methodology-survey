...
# Read Data
########################################
data_link='https://github.com/Jannik-Schaeffer-Log/Q-methodology-survey/blob/main/data/Policies.csv'
df_policies= pd.read_csv(data_link, sep=';',error_bad_lines=False)
